...
df_aggr_trans=pd.read_csv("CSV/aggregated_transaction.csv")

df_aggr_user=pd.read_csv("CSV/aggregated_user.csv")

df_map_trans=pd.read_csv("CSV/map_transaction.csv")

df_map_user=pd.read_csv("CSV/map_user.csv")

df_top_trans=pd.read_csv("CSV/top_transaction.csv")

df_top_user=pd.read_csv("CSV/top_user.csv")
